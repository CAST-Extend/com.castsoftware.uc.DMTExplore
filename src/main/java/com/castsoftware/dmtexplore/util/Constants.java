...
{
	public static final String APPLICATION = "xmlExplore";

	
	public static final String VERSION = "version";
	public static final String DMT_LOCATION = "dmtRoot";
	public static final String OUTPUT_FILE = "outputFile";
	public static final String CURRENT_TO_BASE= "curentToBase";
	public static final String CURRENT_TO_PREV = "curentToPrev";
